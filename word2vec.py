...
if __name__ == "__main__":
    ...
    parser.add_argument("--emb-dim", type=int, help="Embedding Dimension", default=256)
    parser.add_argument("--vocab-size", type=int, help="Size of vocabulary", default=20000)
